...
<div class="container">
  ...
  <main class="post-content">
    ...
    <p>On peut également noter l’existence du principe des “préférences morales”, où les émotions comme l’empathie, la culpabilité, et même la colère entre en jeu. L’individu fait ses choix en interrogeant sa morale et en essayant de se conformer à
      ...
      confortable pour soi de mettre l’autre dans un position de confort, pour éviter un retour agressif par exemple. </p>
    <p>Dans la rationalité limitée, d'Herbert Simon (1965), l’individu est supposé avoir un comportement rationnel, mais les informations qu’il a à sa disposition sont limitées. La rationalité s’exerce de façon séquentielle et non continue. C’est à
      dire que l’individu s'arrête lorsqu’il a trouvé un choix satisfaisant, même si cette solution n’est pas optimale. En effet, il n’est pas possible pour un être humain de concevoir tous les éléments qui entrent en compte lors d’un choix. De même,
      il ne peut pas connaître les résultats de chacun des différents choix qu’il a à sa disposition. Les émotions participent justement à ce processus de tri et minimisent le nombre de choix possibles pour l'individu [3].</p>
    <p>Le principe de rationalité, tel qu'il s'applique dans la théorie des jeux, est une hypothèse sur le comportement. Il a été défini dans l'introduction. On rappelle qu’il pousse l’individu à maximiser ses gains, et à minimiser ses coûts. Dans le
      cadre de jeux comme le jeu de l’ultimatum, les comportements des individus ne respectent pas ce principe de rationalité. L’étude des émotions en économie permet de comprendre pourquoi ce principe n'était pas toujours respecté. </p>
    <h3>Pourquoi les émotions sont-elles indispensables à la prise
      de décision ?</h3>
    ...
    Les émotions, et notamment le souvenirs d’émotions agréables ou pénibles, interviennent pour orienter notre choix. Par exemple le souvenir d’une émotion heureuse après avoir mangé une pâtisserie nous poussera à reprendre la même pâtisserie
      ...
      à se protéger d’un danger potentiel.</p>
    <h4>Les individus se soucient du regard des autres</h4>
    <p>La peur du jugement de l’autre peut influencer lors de la prise de décision. Cela peut se démontrer avec un autre jeu économique proche du jeu de l’ultimatum, le jeu du dictateur. Dans cette variante au jeu de l'ultimatum, le joueur qui
      propose l’offre a le pouvoir de l’imposer à l’autre. Le receveur n’a pas d’autre choix que d’accepter l’offre qui lui est proposée. Si on compare les résultats du jeu de l’ultimatum avec celui du jeu du dictateur, les offres non nulles ne sont
      plus le résultats de la peur du refus de l’offre de la part de l’autre joueur. Elles peuvent résulter d'une forme d'empathie ou d'altruisme. Mais l’empathie n’est pas la seule émotion à entrer en compte dans ce cas. Le joueur peut chercher à se
      présenter sous une image favorable auprès des autres et de lui-même. C’est probablement pour cette raison que lors de nos propres expériences sur le jeu de l’ultimatum, nous avons observé des offres “étonnantes” dépassant la moitié de la somme
      à partager. Les joueurs ayant fait ces offres avaient généralement envie de passer pour des personnes généreuses.
    </p>
    <h2>Utilisation stratégique de la colère</h2>
    <h3>Importance du contrôle des émotions lors de la négociation</h3>
    <h4>Conséquences de la colère sur la négociation</h4>
    <p>La colère est utile en situation de négociation. Les émotions négatives, contrairement aux émotions positives, sont associées à une moindre confiance en soi (qu’elles en soient l’origine ou la cause), et amènent donc l’individu à davantage de
      vigilance. Ces émotions permettraient également de mettre en place des stratégies plus compétitives, car elles sont moins basées sur la coopération. L’individu serait donc moins enclin à faire des concessions. La colère peut également être
      signe de détermination ou d’engagement [16]. Mais, si on se place par exemple dans le cadre du jeu de l’ultimatum, elle aura tendance à déclencher le rejet d’une offre et à écarter le choix rationnel [18].</p>
    <h4>Contrôle de la colère et processus de distance émotionnelle</h4>
    ...
    <p>Contrairement à la réponse numérique, la réponse affective conduit l’offreur à se concentrer sur son propre point de résistance. La réaction affective est d’ailleurs très utilisée par les négociateurs expérimentés [1].</p>
    <h2>Colère, punition et sensibilité morale</h2>
    <h3>L’injustice généralement source de colère</h3>
    <p>Les émotions sont dites sociales lorsqu’elles impliquent une évaluation de son propre comportement ou de celui d’autrui. La colère est considérée comme une émotion sociale [18].</p>
    <p>Les résultats expérimentaux de Rotemberg (2008) [9] sur le jeu de l’ultimatum ont montré qu’en dessous d’un certain seuil, l’offre provoque de la colère. Il y a donc un sentiment d’injustice qui serait en lien avec le déclenchement de la
      colère, ou le sentiment qu’un événement est blâmable.</p>
...
Il permet d'observer les différents types de comportements, et l'impact des états affectifs sur ces comportements. (La négociation : les enseignements du jeu de l’ultimatum, PETIT)</p>
    <h3>Présentation</h3>
    <p>Le jeu de l'ultimatum comporte deux joueurs. Une somme d'argent est à répartir entre ces deux joueurs.</p>
    <p>Un joueur est désigné comme « l'offreur » : il doit décider du montant à attribuer à chacun. L'autre joueur est le « répondant ». Il ne décide pas du montant, mais a le droit de refuser l'offre (si celle-ci lui paraît injuste par exemple).
      S'il refuse, aucun des joueurs ne gagne de l’argent.
    </p>
    <img src="images/P3/schema_jeu_ultimatum.png" alt="Déroulement du jeu de l'ultimatum">
